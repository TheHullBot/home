...
> и без повреждения лакокрасочного покрытия. Второе направление: подводный осмотр
> корпуса инспекционным роботом, отчёт по состоянию подводной части и поиск
> посторонних предметов перед заходом в порт. Работаем из Санкт-Петербурга и Владивостока.
